(defpackage :rove/reporter/junit
  ;; I can't use slashes in format directives
  ...
  (:export #:junit-reporter
           #:run
           #:*junit-output*)
  (:documentation "Generates a junit report.xml for tests run that can be consumed by many CI systems to report test failures and errors in their own interface.  If the user wants to specify an different filename for the report, they can use the environment variable ROVE_REPORT_FILENAME."))
